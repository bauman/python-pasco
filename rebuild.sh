...
python -c "import pascohelper; print pascohelper.mainparse('/tmp/tmpr41Td2/support.CITRIX/AppData/Local/Microsoft/Windows/Temporary Internet Files/Content.IE5/index.dat', '/tmp/dan.out1' );"